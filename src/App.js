...
// Now we will use class based component
    ...
    return (
      <div>
        <Router>
          ...
          />
          <Routes>
            {/* In the Route tag the exact property is used to mount the category given because the app is not mounting the new category after a category is mounted */}
